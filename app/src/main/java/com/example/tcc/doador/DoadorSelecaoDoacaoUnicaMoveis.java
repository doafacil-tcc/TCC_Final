...
public class DoadorSelecaoDoacaoUnicaMoveis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChat = findViewById(R.id.btnChamarChatUnicaMoveis);
        btnDoar = findViewById(R.id.btnAceitarDoacaoMoveis);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        Intent i = new Intent(DoadorSelecaoDoacaoUnicaMoveis.this, ChatActivity.class);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        Intent i = new Intent(DoadorSelecaoDoacaoUnicaMoveis.this, DoadorClickDoar.class);

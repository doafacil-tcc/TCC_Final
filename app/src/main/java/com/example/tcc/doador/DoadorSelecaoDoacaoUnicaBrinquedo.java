...
public class DoadorSelecaoDoacaoUnicaBrinquedo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.doador_activity_selecao_doacao_unica_brinquedo);
    ...
    private void ColetaDadosBrinquedoDoador() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        TextView categoria = (TextView) findViewById(R.id.txtSelecaoBrinquedoDoadorCategoria);
                        TextView tipo = (TextView) findViewById(R.id.txtSelecaoBrinquedoDoadorTipo);
                        TextView qtd = (TextView) findViewById(R.id.txtSelecaoBrinquedoDoadorQuantidade);
                        TextView descricao = (TextView) findViewById(R.id.txtSelecaoBrinquedoDoadorDescrição);
                        ImageView foto1 = (ImageView) findViewById(R.id.imgSelecaoBrinquedoDoador);
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (document.exists()) {
                                        ...
                                        TextView username = (TextView) findViewById(R.id.txtSelecaoBrinquedoDoadorDoador);
                                        TextView endereco = (TextView) findViewById(R.id.txtSelecaoBrinquedoDoadorEndereco);
